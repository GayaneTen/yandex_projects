...
| :-------------------- | ---------------------: |:---------------------------:|
| [AB test](https://github.com/GayaneTen/yandex_projects/tree/main/AB%20test) | с выравниванием справаЗадача: необходимо програлазировать результаты A/B теста, определить, нужно ли продолжать эксперимент или завершить.  |Проект выполняла с помощью Python в Jupyter Notebook, с использованием бибиотек pandas, numpy, matplotlib|
| :-------------------- | ---------------------: |:---------------------------:|
